...
| Tier | NJORD Stake | Daily Volume Limit |
|------|------------|-------------------|
...
*Interested in becoming a bridge operator? [Learn more about the bridge role](/bridges) or [get started with the Bridge SDK](/getting-started).*
